...
/**
 * The Athena class is used for all database interactions with each Hercules server,
 * hence its name.
 *
...
class Flux_Athena {	
	/**
	 * Connection object for saving and retrieving data to the Hercules databases.
	 *
	 * @access public
	 * @var Flux_Connection
	 */
	...
	/**
	 * Login server object tied to this collective Hercules server.
	 *
	 * @access public
	...
	/**
	 * Character server object tied to this collective Hercules server.
	 *
	 * @access public
	 * @var Flux_CharServer
	 */
	...
	/**
	 * Map server object tied to this collective Hercules server.
	 *
	 * @access public
	 * @var Flux_MapServer
	 */
