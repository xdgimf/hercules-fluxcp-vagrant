...
<strong>Note:</strong> You will need to provide a working e-mail address to confirm your account before you can log-in.<br />
<?php endif ?>
<strong>Note:</strong> <?php echo sprintf("Your password must be between %d and %d characters.", Flux::config('MinPasswordLength'), Flux::config('MaxPasswordLength')) ?><br />
<?php if (Flux::config('PasswordMinUpper') > 0): ?>
<strong>Note:</strong> <?php echo sprintf(Flux::message('PasswordNeedUpper'), Flux::config('PasswordMinUpper')) ?><br />
<?php endif ?>
<?php if (Flux::config('PasswordMinLower') > 0): ?>
<strong>Note:</strong> <?php echo sprintf(Flux::message('PasswordNeedLower'), Flux::config('PasswordMinLower')) ?><br />
<?php endif ?>
<?php if (Flux::config('PasswordMinNumber') > 0): ?>
<strong>Note:</strong> <?php echo sprintf(Flux::message('PasswordNeedNumber'), Flux::config('PasswordMinNumber')) ?><br />
<?php endif ?>
<?php if (Flux::config('PasswordMinSymbol') > 0): ?>
<strong>Note:</strong> <?php echo sprintf(Flux::message('PasswordNeedSymbol'), Flux::config('PasswordMinSymbol')) ?><br />
<?php endif ?>
<?php if (!Flux::config('AllowUserInPassword')): ?>
<strong>Note:</strong> <?php echo Flux::message('PasswordContainsUser') ?><br />
<?php endif ?>
</div>
